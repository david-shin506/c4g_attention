...
class CheckpointingCfg:
    ...
    # Also keep a fixed-name `last.ckpt` (Lightning save_last) next to the
    # step-named checkpoints, so the latest state has a stable path.
...
class RootCfg:
    ...
    train: TrainCfg
    seed: int
    force_davis_intrinsics: bool = False
