#!/usr/bin/env python3
"""Save cam02--12 renders using one pose per static physical camera."""
...
def main() -> None:
    ...
    run_spec = {
        "purpose": "static-shared-pose synchronized 24-panel video source render",
        "config": str(config),
        ...
        "saved_prediction_views_per_scene": 132,
        "camera_01_second_panel_role": "synchronized input copy; canonical pose is not optimized",
        "camera_02_to_12_prediction_role": "one optimized pose per physical camera shared across timestamps",
        "optimized_camera_poses_per_scene": len(target_cameras),
        "force_davis_intrinsics": True,
        "align_pose": True,
        "share_target_pose": True,
        "shared_pose_scope": "per physical camera",
        "use_vggt_target_pose": False,
        "pose_alignment_objective": "official full-frame MSE + LPIPS averaged across timestamps",
